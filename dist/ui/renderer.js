 ...
 * ```
 */
export function HitUIRenderer({ spec, apiBase, components = {}, onNavigate, onCustomAction, errorFallback, loadingFallback, }) {
    // Merge custom components with defaults
    const registry = { ...DEFAULT_REGISTRY, ...components };
    return (_jsx(HitUIProvider, { apiBase: apiBase, onNavigate: onNavigate, onCustomAction: onCustomAction, children: _jsx("div", { className: "hit-ui-root", children: _jsx(RenderSpec, { spec: spec, registry: registry }) }) }));
}
/**
 ...
 */
export function HitUIFromEndpoint({ endpoint, apiBase, components = {}, onNavigate, onCustomAction, loadingFallback, errorFallback, }) {
    ...
    return (_jsx(HitUIRenderer, { spec: spec, apiBase: apiBase, components: components, onNavigate: onNavigate, onCustomAction: onCustomAction }));
}
