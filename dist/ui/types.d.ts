...
export type ActionSpec = NavigateAction | ApiCallAction | SubmitAction | OpenModalAction | CloseModalAction | RefreshAction | CustomAction;
...
export type FieldSpec = TextFieldSpec | TextAreaFieldSpec | NumberFieldSpec | SelectFieldSpec | CheckboxFieldSpec | DateFieldSpec | HiddenFieldSpec;
